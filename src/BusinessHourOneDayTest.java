 ...
 */
public class BusinessHourOneDayTest {
    ...
    public void testWeekends() {
        ...
        assertEquals(0, BusinessHourOneDay.calSecondsByDate(saturday));
    }
    ...
    public void testWeekenddays() {
        ...
        assertEquals(SECONDS_OF_ONE_WORKING_DAY, BusinessHourOneDay.calSecondsByDate(saturday));
    }
    ...
    public void testHoliday() {
        ...
        assertEquals(0, BusinessHourOneDay.calSecondsByDate(newYearsDay));
    }
    ...
    public void testInWorkingDate() {
        ...
        assertEquals(SECONDS_OF_ONE_WORKING_DAY, BusinessHourOneDay.calSecondsByDateTime(begin, null));

        // 근무 시작과 근무 종료 사이 등록 된 문의
        int regHour = 15;
        begin = LocalDateTime.of(2018, 1, 5, regHour, 0, 0);
        assertEquals((BusinessHourOneDay.END_WORK_HOUR - regHour) * MINUTES_OF_ONE_HOUR * SECONDS_OF_ONE_MINUTE, BusinessHourOneDay.calSecondsByDateTime(begin, null));

        // 근무 시작 이후에 등록된 문의
        begin = LocalDateTime.of(2018, 1, 5, 20, 0, 0);
        assertEquals(0, BusinessHourOneDay.calSecondsByDateTime(begin, null));

        // 근무일에 종료된 문의
        // 근무 시작 전 종료 된 문의
        LocalDateTime end = LocalDateTime.of(2018, 1, 5, 8, 0, 0);
        assertEquals(0, BusinessHourOneDay.calSecondsByDateTime(null, end));

        // 근무 시작과 근무 종료 사이 종료 된 문의
        regHour = 15;
        end = LocalDateTime.of(2018, 1, 5, regHour, 0, 0);
        assertEquals((regHour - BusinessHourOneDay.BEGIN_WORK_HOUR) * MINUTES_OF_ONE_HOUR * SECONDS_OF_ONE_MINUTE, BusinessHourOneDay.calSecondsByDateTime(null, end));

        // 근무 시작 이후에 종료된 문의
        end = LocalDateTime.of(2018, 1, 5, 20, 0, 0);
        assertEquals(SECONDS_OF_ONE_WORKING_DAY, BusinessHourOneDay.calSecondsByDateTime(null, end));
    }
    ...
    public void testInWorkingDateTime() {
        ...
        assertEquals(30 * SECONDS_OF_ONE_MINUTE - 45, BusinessHourOneDay.calSecondsByDateTime(begin, null));
        ...
        assertEquals(20 * SECONDS_OF_ONE_MINUTE + 35, BusinessHourOneDay.calSecondsByDateTime(null, end));
